...
class MusicPlayerState extends State<MusicPlayer> {
  ...
  Widget build(context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.amber,leading: IconButton(onPressed: ()  {
      ...
      body: Container(
        ...
        child: Column(children:<Widget>[
          CircleAvatar(backgroundImage: widget.songInfo.albumArtwork==null?AssetImage('assets/images/music2.jpg'):FileImage(File(widget.songInfo.albumArtwork)),radius: 135,),
          Container( margin: EdgeInsets.fromLTRB(10, 50, 10, 10),child: Text(widget.songInfo.title, style: TextStyle(color: Colors.black, fontSize: 16.0, fontWeight: FontWeight.w600),
          ),),
          Container( margin: EdgeInsets.fromLTRB(10, 10, 10, 10),child: Text(widget.songInfo.artist, style: TextStyle(color: Colors.grey, fontSize: 13.0, fontWeight: FontWeight.w500),
          ),),
